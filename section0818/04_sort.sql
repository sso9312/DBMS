● [Sort 정렬] 
  ...
  - 형식) order by 칼럼명1, 칼럼명2, 칼럼명3, ~~ --데이터베이스에서 정렬하고 자바로 가져오는게 편리
...
select uname, from sungjuk order by uname where aver<=70; --ORA 00933에러 발생
