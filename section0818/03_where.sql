...
select uname sungjuk where uname='대한민국';
--------------------------------------------------------------
...
select count(*) from sungjuk where tot is null;  --null값 확인해야 하는 경우. 5 is연산자 이용
